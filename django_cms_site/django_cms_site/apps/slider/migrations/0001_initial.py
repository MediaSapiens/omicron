...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('slider_slide', (
            ...
            ('link_url', self.gf('django.db.models.fields.URLField')(max_length=255)),
        ...
        db.create_table('cmsplugin_sliderplugin', (
            ...
            ('slider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['slider.Slide'])),
        ))
        db.send_create_signal('slider', ['SliderPlugin'])
    ...
    models = {
        ...
        'slider.sliderplugin': {
            ...
            'slider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['slider.Slide']"})
        }
    }
